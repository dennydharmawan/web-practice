        ...
        <div>
          <div className="pancake-grid items-start [--custom-gap:1.5rem] [--custom-min:320px]">
            {pageObjects
              ...
              .map((pageObject) => (
                <section key={pageObject.id} aria-labelledby={pageObject.id}>
                  <Card shadow="sm" padding="sm" component="a" href={pageObject.path} target="_blank">
                    {/* <Card.Section>
                  <Image
                  ...
                  />
                    ...
                    <h3 id={pageObject.id} className="text-2xl font-bold text-primary">
                      {pageObject.title}
                    </h3>
